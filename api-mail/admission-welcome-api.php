...
// $Cordinator_Name= $data['CordinatorName'];
// $Cordinator_PhoneNumber = $data['CordinatorPhoneNumber'];
...
$mail->Subject  = 'Welcome to ' .$CompanyName. '- Admission Successfull';
...
$mail->Body = "<div style='background-color:#fbfbfc;margin:0'>
        ...
        <tbody>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <tbody>
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'><b>Thank You</b> <br> <br>Your admission is successfully in $CompanyName. If you have any query Realated your admission please let us know. we will resolve ASAP.
                            ...
                            <td><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:18px;color:#20252e;font-weight:bold'>Team $CompanyName</span></td>
            ...
            <td style='font-family:'open sans','arial',sans-serif;font-size:12px;line-height:130%;color:#9f9f9f;text-align:center' align='center'>© 2023 $CompanyName.&nbsp;All rights reserved. <br><a href='$WebsiteLink' title='$CompanyName' style='color:#9f9f9f;font-family:'open sans','arial','verdana',sans-serif' target='_blank' >$CompanyDomain</a></td>
