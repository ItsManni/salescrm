...
$mail->Subject  = 'Payment Sucessfull - '.$CompanyName;
...
$mail->Body = "<div style='background-color:#fbfbfc;margin:0'>
        ...
        <tbody>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <tbody>
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'><b>Thank You</b> <br> <br> Your Payment has been successfully transfered. Our Team will contact you soon for future process. 
         ...
         $mail->addCC("manishsharma.gary@gmail.com");
