...
<head>
    ...
    <!-- TITLE -->
    <title>View All Partner - Webomates Partnership Portal</title>
    <?php
...
<body class="app sidebar-mini ltr light-mode">
    <div class="page">
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title">Webomates File Manager</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)"> File Manager</a>
                                    </li>
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <button class="btn btn-primary btn-block" data-bs-target="#createfile"
                                            data-bs-toggle="modal"><i class="fe fe-plus me-1"></i> Create New
                                            File</button>
                                    </div>
                                        ...
                                        <div class="list-group list-group-transparent mb-0 file-manager">
                                            ...
                                            <div class="d-flex">
                                                <div>
                                                    <a href="javascript:void(0);"
                                                        class="list-group-item  d-flex align-items-center px-0">
                                                        <i class="fe fe-download fs-18 me-2 text-info p-2"></i>
                                                        Downloads
                                                    </a>
                                                </div>
                                                <div class="text-end ms-auto mt-3">
                                    ...
                                    <div class="card-body">
                                        <div class="list-group list-group-transparent mb-0">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="list-group-item  d-flex align-items-center px-0 py-2">
                                                <span class="text-danger me-2 fs-12"><i
                                                        class="fe fe-circle"></i></span>FTP Files
                                            </a>
                                            <a href="javascript:void(0);"
                                                class="list-group-item  d-flex align-items-center px-0 py-2">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="list-group-item  d-flex align-items-center px-0 py-2">
                                                <span class="text-success me-2 fs-12"><i
                                                        class="fe fe-circle"></i></span>Deep Clean
                                            </a>
                                            <a href="javascript:void(0);"
                                                class="list-group-item  d-flex align-items-center px-0 py-2">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="list-group-item  d-flex align-items-center px-0 py-2">
                                                <span class="text-pink me-2 fs-12"><i
                                                        class="fe fe-circle"></i></span>Settings
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <a href="javascript:void(0)" class="file-manager-image"><img
                                                    src="../theme-assets/images/media/files/documents/11.png"
                                                    alt="img"></a>
                                        ...
                                        <div class="">
                                            <div class="d-flex">
                                                <div class="d-flex">
                                                    <div>
                                                        <h6 class="mt-2"><i class="fe fe-circle text-success fs-12"></i>
                                                            Total Storage</h6>
                                                        <span class="text-muted">128 GB</span>
                                                    </div>
                                                </div>
                                                <div class="ms-auto my-auto">
                                                    <h6 class="mt-2"><i class="fe fe-circle text-danger fs-12"></i> Used
                                                    </h6>
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-xl-3 col-md-6 col-sm-6">
                                        <div class="card pos-relative">
                                            <a href="filemanager-list" class="open-file"></a>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-sm-6">
                                        <div class="card pos-relative">
                                            ...
                                            <div class="card-body px-4 pt-4 pb-2">
                                                <div class="d-flex">
                                                    <span
                                                        class="bg-secondary-transparent border border-secondary brround">
                                                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                                                            <path fill="#05c3fb"
                                ...
                                <div class="row row-sm">
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/6.png"
                                                    alt="img"></a>
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/07.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/2.png"
                                                    alt="img"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/06.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/7.png"
                                                    alt="img"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/10.png"
                                                    alt="img"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/8.png"
                                                    alt="img"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/01.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/02.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="d-flex">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/04.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details"><img
                                                    src="../theme-assets/images/media/files/05.jpg" alt="img"
                                                    class="w-100 file-manager-list"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
                                    ...
                                    <div class="col-xl-4 col-xxl-3 col-lg-6 col-md-6 col-sm-6">
                                        <div class="card overflow-hidden">
                                            <a href="filemanager-details" class="mx-auto my-3"><img
                                                    src="../theme-assets/images/media/files/documents/9.png"
                                                    alt="img"></a>
                                            <div class="card-footer">
                                                <div class="d-flex">
                                                    <div class="">
       ...
       include("../include/common-script.php");
        ...
        <script src="../project-assets/js/partner.js"></script>
