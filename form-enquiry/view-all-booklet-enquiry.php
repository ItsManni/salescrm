...
<head>
    ...
    <!-- TITLE -->
    <title>View All Booklet Enquiry - <?= $_ProductName ?> Portal</title>
    <?php 
    ...
    $booklet_enquiry = $Enquiry->GetAllBookletEnquiry($conn);
    ?>
</head>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header mb-3">
                            <h1 class="page-title">All Booklet Enquiry</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../dashboard/admin-dashboard">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Booklet Enquiry</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                            ...
                            <form id="export_fillter_form">
                                <div class="row row-sm pt-2 pb-2 justify-content-center">
                                        ...
                                        <div class="col-2 text-center d-flex">
                                              ...
                                              <span onclick="ExportBookletEnquiryData()" class="btn btn-info">Export</span>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap border-bottom"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $i=1;
                                                    foreach($booklet_enquiry as $booklet_value)
                                                    {
                                                ...
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $booklet_value['Name']; ?></td>
                                                    <td><?php echo $booklet_value['FatherName']; ?></td>
                                                    <td><?php echo $booklet_value['MobileNumber']; ?></td>
                                                    <td><?php echo $booklet_value['Email']; ?></td>
       ...
       include("../include/common-script.php");
        ...
        <script type="text/javascript">
             ...
             $(document).ready(function() {
              ...
              $("#nav_booklet_form").addClass("active");
            });
         </script>
</body>
