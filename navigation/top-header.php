    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="<?= $_ProductLogo ?>" class="header-brand-img desktop-logo w-50" alt="logo">
                <img src="<?= $_ProductLogo ?>" class="header-brand-img light-logo1 w-50" alt="logo">
            </a>
            <!-- LOGO -->
            ...
            if($center_filter_display)
            {
            ?>
            <div class="col-lg-4 ml-auto">
                <div class="row justify-content-center">
                    <div class="col-12 text-left">
                        <select class="form-control" name="center" id="center" onchange="appendQueryString(this.value)">
                            <option value="-1">Select Center/Branch</option>
                            <?php
                            foreach($AllBranches as $Branch_value)
                            {
                                $selected_center = "";
                                if($center_filter == $Branch_value['ID'])
                                {
                                    $selected_center = "selected";
                                }
                            ?>
                                <option value="<?php echo  $Branch_value['ID']?>" <?= $selected_center; ?> ><?php echo  $Branch_value['BranchName']?></option>
                            <?php
                            }
                            ?>
                        </select>
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/products/3.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/products/5.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/products/7.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/products/1.jpg"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/products/2.jpg"></span>
                                            <div class="wd-50p">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/users/1.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/users/15.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/users/12.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/users/4.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="../theme-assets/images/users/3.jpg"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        <div class="text-left">
                                            ...
                                            {
                                                $email_top_header = $_SESSION['pp_email'];
                                                $top_header_UserType = $_SESSION['pp_UserType'];
                                            }
                                            ?>
                                            <h5 class="text-dark mb-0 fs-14 fw-semibold">
                                                <?php echo $email_top_header; ?></h5>
                                            <small class="text-muted"><?php echo $top_header_UserType; ?></small>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider m-0"></div>
