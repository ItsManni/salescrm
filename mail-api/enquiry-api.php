...
$Optional= $data['OptionalCourseName'];
$Module= $data['ModuleName'];


	
$mail->Subject  = 'Welcome to Tathastu - New Enquiry';
$mail->Body = "<div style='background-color:#fbfbfc;margin:0'>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <tbody>
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'>DOB: $DOB
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'>Address: $Address
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'>Highest Qualification: $HighestQualification
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'>Optional: $Optional
                            ...
                            <td style='vertical-align:bottom'><span style='font-family:'open sans','arial','verdana',sans-serif;font-size:16px;color:#444e61'>Module: $Module
        ...
        $mail->addBCC("prabhat.gary@gmail.com");
