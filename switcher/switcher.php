...
<head>
    ...
    <!-- TITLE -->
    <title>ADD Student - <?= $_ProductName ?></title>
...
<body class="app sidebar-mini ltr light-mode">
    <div class="page">
                                ...
                                <div class="col-xl-6 m-auto">
                                    <div class="card sidebar-right1">
                                        ...
                                        <div class="card-body horizontal-switcher">
                                            <div>
                                                <h6 class="main-content-label mb-3">Horizontal Layout Style</h6>
                                            </div>
                                            <div class="switch_section">
                                                <div class="switch-toggle d-flex">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="skin-body switch_section">
                                                ...
                                                <div class="switch-toggle d-flex mt-2">
                                                    <a class="bg-img1 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="../project-assets/images/bg-img1.jpg"  alt="Bg-Image" id="bgimage1" class="br-7"></a>
                                                    <a class="bg-img2 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="../project-assets/images/bg-img2.jpg"  alt="Bg-Image"  id="bgimage2" class="br-7"></a>
                                                    <a class="bg-img3 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="../project-assets/images/bg-img3.jpg"  alt="Bg-Image" id="bgimage3" class="br-7"></a>
                                                    <a class="bg-img4 me-2" href="javascript:void(0);" onclick="bgImage(this)"><img src="../project-assets/images/bg-img4.jpg"  alt="Bg-Image" id="bgimage4" class="br-7"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-body">
       ...
       include("../include/common-script.php");
        ?>
        <script src="../project-assets/js/add-student-admission.js"></script>
