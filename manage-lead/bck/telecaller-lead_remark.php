        ...
        <div class="main-content-app pt-0" style="height:60vh">
            <div class="main-content-body main-content-body-chat h-100">
                        ...
                        ?>
                            <div class="media chat-left">
                                ...
                                <div class="media-body">
                                    ...
                                    <div>
                                        <span><?php echo $Student_remark['CreatedTime']; ?> <b style="color:#c7900f;">Re-marked by : </b> <?php echo $user_array2[$Student_remark['CreatedBy']]; ?></span> <a href="javascript:void(0)"><i class="icon ion-android-more-horizontal"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php
                ...
                <div class="main-chat-footer">
                        ...
                        <button onclick="AddTelecallerLeadRemark()" class="btn btn-icon  btn-primary">Add Remark</button>
                        <nav class="nav">
                        </nav>
