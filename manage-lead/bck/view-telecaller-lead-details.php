...
$_Telecaller_LeadName = $conf->_Telecaller_LeadName;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <!-- TITLE -->
    <title>View Telecaller Lead Details - <?= $_ProductName ?> Portal </title>
    <?php 
    ...
    $lead_details = $ManageLead->GetTelecallerLeadsDetailsByID($LeadID);
    $Lead_remarks_arr = $ManageLead->GetAllTelecallerLeadRemarks($conn,$LeadID);
    $Lead_histroy_arr = $ManageLead->GetAllTelecallerLeadAssignmentHistory($conn,$LeadID);
    ...
    $where = " where 1";
    $lead_status_array_temp = $core->_getTableRecords($conn,'telecaller_lead_status',$where);
    ...
    $access = false;
    if($UserType == "System Admin" || $UserType == "Lead Counsellor" || $UserType == "Counsellor" || $UserType == "Admin" || $UserType == "Center Manager" || $UserType == "Telecaller")
    {
        $access = true;
    }
    ?>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header mb-3">
                            <h1 class="page-title">Telecaller Lead Details</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../dashboard/admin-dashboard">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Telecaller Lead Details</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    ?>
                                                        <div class="tab-pane active" id="lead_details">
                                                            <?php include("include/telecaller-lead-details.php"); ?>
                                                        </div>                                                        
                                                        <div class="tab-pane" id="leadremark">
                                                            <?php include("include/telecaller-lead_remark.php"); ?>
                                                        </div>
                                                       
                                                        <div class="tab-pane" id="leadhistory">
                                                            <?php include("include/telecaller-lead_history.php"); ?>
                                                        </div>
                                                    <?php 
                                                    } 
                                                    ?>
